...
- **Anti-Bot Evasion & Persistent Agents**: Building task-driven research agents with modular plugin systems and advanced heuristics to bypass complex bot detection (e.g., **OpenShrimp**).
...
- **PsychDiary**: A production AI-powered mobile mental health companion leveraging NLP models to provide supportive dialogue and cognitive-behavioral tracking.
- **NavicareNow**: An AI-driven navigation and workflow optimization platform for elderly care and admission documentation.
- **Quant Bots**: Heavy-duty quantitative trading systems utilizing automated forecasting models (e.g., Kronos-mini) and advanced technical analysis.

---

## Technical Stack

- **AI Frameworks**: LangGraph, LangChain, AutoGen, CrewAI.
- **Models & Inference**: Local LLMs (Llama 3, Mistral), OpenAI, Anthropic, TimesFM (Forecasting).
- **ML Libraries**: TensorFlow, Keras, PyTorch, Scikit-learn.
- **Data & Vector Stores**: ChromaDB, Pinecone, PostgreSQL (pgvector).
- **Infrastructure**: Kubernetes (GPU-accelerated), Docker, Python (FastAPI).
